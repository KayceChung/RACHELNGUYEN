export default function Footer() {
  return (
    <footer className="bg-primary text-white py-xl">
      <div className="max-w-[1440px] mx-auto px-margin flex flex-col md:flex-row md:flex-wrap justify-between items-start gap-lg">
        ...
        <div className="flex flex-wrap gap-lg font-utility text-[13px] uppercase opacity-70">
        ...
        <p className="font-utility text-[13px] uppercase opacity-50 max-w-xs md:text-right">
